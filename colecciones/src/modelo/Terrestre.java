...
public class Terrestre extends Transporte {
	...
	public Terrestre(String tipoMotor, double capacidadCarga, int capacidadPasajero, int cantRuedas, int avaluo) {
		super(tipoMotor, capacidadCarga, capacidadPasajero, avaluo );
